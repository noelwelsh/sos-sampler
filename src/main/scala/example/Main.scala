...
def appElement(): HtmlElement =
  ...
  div(
    ...
    div(
      ...
      input(typ := "range", GlobalStyles.slider, value <-- volumeSlider.signal.map(_.toString), onInput.mapToValue.map(_.toDouble) --> volumeSlider),
      label("Volume"),
      input(typ := "range", GlobalStyles.slider, value <-- fadeInSlider.signal.map(_.toString), onInput.mapToValue.map(_.toDouble) --> fadeInSlider),
      label("Fade In"),
      input(typ := "range", GlobalStyles.slider, value <-- fadeOutSlider.signal.map(_.toString), onInput.mapToValue.map(_.toDouble) --> fadeOutSlider),
      label("Fade Out"),
      input(typ := "range", GlobalStyles.slider, value <-- playbackRateSlider.signal.map(_.toString), onInput.mapToValue.map(_.toDouble) --> playbackRateSlider),
      label("Playback Rate"),
      input(typ := "range", GlobalStyles.slider, value <-- startTimeSlider.signal.map(_.toString), onInput.mapToValue.map(_.toDouble) --> startTimeSlider),
      label("Start Time"),
      input(typ := "range", GlobalStyles.slider, value <-- offsetSlider.signal.map(_.toString), onInput.mapToValue.map(_.toDouble) --> offsetSlider),
      label("Offset"),
      input(typ := "range", GlobalStyles.slider,  value <-- durationSlider.signal.map(_.toString), onInput.mapToValue.map(_.toDouble) --> durationSlider),
      label("Duration"),
      ...
      label("Reverse"),
      button("Play", onClick --> firstMusicProgram().unsafeRunAndForget()),
